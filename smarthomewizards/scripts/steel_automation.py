"""Steel.dev Browser Automation for smarthomewizards.com — delegates to shared base."""
...
class SmarthomewizardsAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("smarthomewizards")


if __name__ == "__main__":
    with SmarthomewizardsAutomation() as auto:
