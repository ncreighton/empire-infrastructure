"""Steel.dev Browser Automation for wealthfromai.com — delegates to shared base."""
...
class WealthfromaiAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("wealthfromai")


if __name__ == "__main__":
    with WealthfromaiAutomation() as auto:
