"""Steel.dev Browser Automation for pulsegearreviews.com — delegates to shared base."""
...
class PulsegearreviewsAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("pulsegearreviews")


if __name__ == "__main__":
    with PulsegearreviewsAutomation() as auto:
