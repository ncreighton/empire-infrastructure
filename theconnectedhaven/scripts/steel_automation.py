"""Steel.dev Browser Automation for theconnectedhaven.com — delegates to shared base."""
...
class TheconnectedhavenAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("theconnectedhaven")


if __name__ == "__main__":
    with TheconnectedhavenAutomation() as auto:
