...
### Active Tasks for Sprout-and-Spruce
...
### Content Generation
```
"Generate a pillar article about [TOPIC] for sprout-and-spruce.com"
"Create 5 cluster articles supporting [PILLAR]"
"Write a product review for [PRODUCT] with affiliate links using sproutandspruce-20"
```
...
### DO ✓
- Maintain "nurturing gardener" voice consistently
- Include relevant affiliate links (sproutandspruce-20)
...
### DON'T ✗
- Overwhelming beginners, expensive-only solutions
...
### Key Facts
- This is site 13 of 16 in Nick's publishing empire
...
# Site: Sprout-and-Spruce | Domain: sprout-and-spruce.com | Priority: MEDIUM
