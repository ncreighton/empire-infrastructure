"""Steel.dev Browser Automation for sproutandspruce.com — delegates to shared base."""
...
class SproutandspruceAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("sproutandspruce")


if __name__ == "__main__":
    with SproutandspruceAutomation() as auto:
