"""Steel.dev Browser Automation for aidiscoverydigest.com — delegates to shared base."""
...
class AidiscoverydigestAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("aidiscoverydigest")


if __name__ == "__main__":
    with AidiscoverydigestAutomation() as auto:
