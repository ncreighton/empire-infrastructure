"""Steel.dev Browser Automation for celebrationseason.com — delegates to shared base."""
...
class CelebrationseasonAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("celebrationseason")


if __name__ == "__main__":
    with CelebrationseasonAutomation() as auto:
