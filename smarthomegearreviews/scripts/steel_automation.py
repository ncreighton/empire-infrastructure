"""Steel.dev Browser Automation for smarthomegearreviews.com — delegates to shared base."""
...
class SmarthomegearreviewsAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("smarthomegearreviews")


if __name__ == "__main__":
    with SmarthomegearreviewsAutomation() as auto:
