"""Steel.dev Browser Automation for witchcraftforbeginners.com — delegates to shared base."""
...
class WitchcraftforbeginnersAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("witchcraftforbeginners")


if __name__ == "__main__":
    with WitchcraftforbeginnersAutomation() as auto:
