...
MODULE_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "agent": {
        ...
        "entry": "main",
        "commands": ["goal", "run", "status", "goals", "sessions", "action", "converse", "delegate"],
        "deps": ["anthropic"],
    },
    # ── Phase 6 Modules ──
    "circuit-breaker": {
        "module": "src.circuit_breaker",
        "description": "Circuit breaker & retry policies",
        "entry": "main",
        "commands": ["status", "reset", "list", "test"],
        "deps": [],
    },
    "audit": {
        "module": "src.audit_logger",
        "description": "Structured audit logging",
        "entry": "main",
        "commands": ["search", "export", "stats", "recent"],
        "deps": [],
    },
    "encrypt": {
        "module": "src.encryption_layer",
        "description": "Data encryption at rest",
        "entry": "main",
        "commands": ["encrypt", "decrypt", "rotate-keys", "status"],
        "deps": [],
    },
    "prompts": {
        "module": "src.prompt_library",
        "description": "Versioned prompt templates",
        "entry": "main",
        "commands": ["list", "get", "test", "ab-status", "categories"],
        "deps": [],
    },
    "ratelimit": {
        "module": "src.rate_limit_manager",
        "description": "Platform-aware rate limiting",
        "entry": "main",
        "commands": ["status", "reset", "configure", "stats"],
        "deps": [],
    },
    "benchmark": {
        "module": "src.performance_benchmarker",
        "description": "Performance tracking & SLA monitoring",
        "entry": "main",
        "commands": ["report", "sla", "export", "reset"],
        "deps": [],
    },
    "quality": {
        "module": "src.content_quality_scorer",
        "description": "Content quality scoring",
        "entry": "main",
        "commands": ["score", "batch", "thresholds", "report"],
        "deps": [],
    },
    "rag": {
        "module": "src.rag_memory",
        "description": "RAG semantic search over memory",
        "entry": "main",
        "commands": ["search", "index", "context", "stats"],
        "deps": [],
    },
    "backup": {
        "module": "src.backup_manager",
        "description": "State backup & restore",
        "entry": "main",
        "commands": ["full", "incremental", "restore", "list", "prune"],
        "deps": [],
    },
    "anomaly": {
        ...
        "entry": "main",
        "commands": ["detect", "report", "configure", "history"],
        "deps": [],
    },
    "devices": {
        "module": "src.device_pool",
        "description": "Unified phone & cloud device pool",
        "entry": "main",
        "commands": ["discover", "list", "health", "execute", "cost"],
        "deps": [],
    },
    "mobile-test": {
        "module": "src.mobile_test_framework",
        "description": "Mobile visual regression testing",
        "entry": "main",
        "commands": ["run", "report", "baseline", "compare"],
        "deps": [],
    },
    "pipeline": {
        "module": "src.content_pipeline",
        "description": "14-stage content pipeline",
        "entry": "main",
        "commands": ["execute", "batch", "fill", "status", "history"],
        "deps": ["anthropic"],
    },
    "orchestrator": {
        "module": "src.unified_orchestrator",
        "description": "Unified mission orchestrator",
        "entry": "main",
        "commands": ["mission", "converse", "status", "modules", "history"],
        "deps": ["anthropic"],
    },
    "workflows": {
        "module": "src.workflow_templates",
        "description": "Mission workflow templates",
        "entry": "main",
        "commands": ["list", "show", "execute", "create", "validate"],
        "deps": [],
    },
    "substack": {
        "module": "src.substack_agent",
        "description": "Substack newsletter automation",
        "entry": "main",
        "commands": ["daily", "write", "publish", "promote", "analytics", "subscribers", "calendar", "accounts", "revenue", "stats", "batch-write"],
        "deps": ["anthropic"],
    },
    "ab-test": {
        "module": "src.ab_testing",
        "description": "A/B testing experiments",
        "entry": "main",
        "commands": ["create", "list", "record", "results", "conclude", "report"],
        "deps": [],
    },
    "marketplace": {
        "module": "src.marketplace_optimizer",
        "description": "KDP + Etsy listing optimization",
        "entry": "main",
        "commands": ["optimize", "keywords", "pricing", "batch", "report"],
        "deps": ["anthropic"],
    },
    "email-list": {
        "module": "src.email_list_builder",
        "description": "Email capture & nurture sequences",
        "entry": "main",
        "commands": ["add", "list", "segment", "sequence", "form", "lead-magnet", "health", "growth"],
        "deps": ["anthropic"],
    },
    "competitor": {
        "module": "src.competitor_intel",
        "description": "Competitive intelligence",
        "entry": "main",
        "commands": ["add", "list", "keyword-gaps", "content-gaps", "velocity", "opportunities", "strategy", "report"],
        "deps": ["anthropic"],
    },
    "audience": {
        "module": "src.audience_analytics",
        "description": "Audience segmentation & analytics",
        "entry": "main",
        "commands": ["track", "profile", "rfm", "segment", "cohort", "insights", "growth", "report"],
        "deps": [],
    },
    "forecast": {
        "module": "src.revenue_forecaster",
        "description": "Revenue forecasting",
        "entry": "main",
        "commands": ["predict", "ensemble", "seasonal", "report", "compare"],
        "deps": [],
    },
    "payments": {
        "module": "src.payment_processor",
        "description": "Payment tracking & invoicing",
        "entry": "main",
        "commands": ["record", "list", "invoice", "reconcile", "report"],
        "deps": [],
    },
}
