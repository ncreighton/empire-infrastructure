"""Steel.dev Browser Automation for wearablegearreviews.com — delegates to shared base."""
...
class WearablegearreviewsAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("wearablegearreviews")


if __name__ == "__main__":
    with WearablegearreviewsAutomation() as auto:
