"""Steel.dev Browser Automation for aiinactionhub.com — delegates to shared base."""
...
class AiinactionhubAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("aiinactionhub")


if __name__ == "__main__":
    with AiinactionhubAutomation() as auto:
