...
|--------|---------|-------------|-------|
| content-pipeline | 1.1.0 [OK] | critical | daily |
| image-optimization | 1.1.0 [OK] | high | daily |
| seo-toolkit | 1.1.0 [OK] | critical | daily |
| api-retry | 1.1.0 [OK] | high | hourly |
| wordpress-automation | 1.1.0 [OK] | high | daily |
| affiliate-link-manager | 1.1.0 [OK] | high | weekly |
...
**Stack:** WordPress 6.9, Blocksy, RankMath, LiteSpeed Cache, Elementor

## Design Reference
Full design blueprint (colors, typography, navigation, components, page layouts):
See `DESIGN-BLUEPRINT.md` in this directory.
