"""Steel.dev Browser Automation for family-flourish.com — delegates to shared base."""
...
class FamilyflourishAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("familyflourish")


if __name__ == "__main__":
    with FamilyflourishAutomation() as auto:
