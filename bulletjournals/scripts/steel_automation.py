"""Steel.dev Browser Automation for bulletjournals.net — delegates to shared base."""
...
class BulletjournalsAutomation(SteelWPBase):
    """Backwards-compatible wrapper."""
    def __init__(self):
        super().__init__("bulletjournals")


if __name__ == "__main__":
    with BulletjournalsAutomation() as auto:
