...
SITE_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "aiinactionhub.com": {
        ...
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("aiinactionhub.com"), "mimic_name": "aiinactionhub.com"},
        "custom_prompt": True,
        ...
        "wordpress_settings": {
            ...
            "category": "Automatically Determine Category",
            "article_status": "schedule",
            "posts_per_day": "4",
            "schedule_start_current_day": True,
        },
    ...
    "aidiscoverydigest.com": {
        ...
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("aidiscoverydigest.com"), "mimic_name": "aidiscoverydigest.com"},
        "custom_prompt": True,
    ...
    "clearainews.com": {
        ...
        "serp_settings": {"country": "United States", "language": "English", "enable": True},
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("clearainews.com"), "mimic_name": "clearainews.com"},
        "custom_prompt": True,
    ...
    "wealthfromai.com": {
        ...
        "serp_settings": {"country": "United States", "language": "English", "enable": True},
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("wealthfromai.com"), "mimic_name": "wealthfromai.com"},
        "custom_prompt": True,
    ...
    "smarthomewizards.com": {
        ...
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("smarthomewizards.com"), "mimic_name": "smarthomewizards.com"},
        "custom_prompt": True,
    ...
    "smarthomegearreviews.com": {
        ...
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("smarthomegearreviews.com"), "mimic_name": "smarthomegearreviews.com"},
        "custom_prompt": True,
    ...
    "theconnectedhaven.com": {
        ...
        "serp_settings": {"country": "United States", "language": "English", "enable": True},
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("theconnectedhaven.com"), "mimic_name": "theconnectedhaven.com"},
        "custom_prompt": True,
    ...
    "witchcraftforbeginners.com": {
        ...
        "serp_scraping": False,
        "deep_research": True,
        "deep_research_settings": {"ai_model": "Sonar Online (OR)", "links_per_article": "2", "links_per_subheading": "1"},
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("witchcraftforbeginners.com"), "mimic_name": "witchcraftforbeginners.com"},
        "custom_prompt": True,
    ...
    "manifestandalign.com": {
        ...
        "deep_research_settings": {"ai_model": "Sonar Online (OR)", "links_per_article": "2", "links_per_subheading": "1"},
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("manifestandalign.com"), "mimic_name": "manifestandalign.com"},
        "custom_prompt": True,
    ...
    "family-flourish.com": {
        ...
        "serp_settings": {"country": "United States", "language": "English", "enable": True},
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("family-flourish.com"), "mimic_name": "family-flourish.com"},
        "custom_prompt": True,
    ...
    "mythicalarchives.com": {
        ...
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("mythicalarchives.com"), "mimic_name": "mythicalarchives.com"},
        "custom_prompt": True,
    ...
    "wearablegearreviews.com": {
        ...
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("wearablegearreviews.com"), "mimic_name": "wearablegearreviews.com"},
        "custom_prompt": True,
    ...
    "pulsegearreviews.com": {
        ...
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("pulsegearreviews.com"), "mimic_name": "pulsegearreviews.com"},
        "custom_prompt": True,
    ...
    "bulletjournals.net": {
        ...
        "deep_research_settings": {"ai_model": "Sonar Online (OR)", "links_per_article": "2", "links_per_subheading": "1"},
        "style_mimic": True,
        "style_mimic_settings": {"style_text": _load_style_sample("bulletjournals.net"), "mimic_name": "bulletjournals.net"},
        "custom_prompt": True,
